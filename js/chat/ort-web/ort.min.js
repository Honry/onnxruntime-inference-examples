...
`}var Qc,tp,ss,ls=x(()=>{"use strict";U();X();R();ge();Qc=i=>({name:"Reshape (packed)",inputTypes:[2],inputNames:["A"],cacheHint:`${i}`}),tp=(i,e,o,t)=>{let r=e.dims,n=t,s="";for(let l=0;l<4;l++){let f="";switch(l){case 0:f="outputCoords = rc;";break;case 1:f="outputCoords = ivec3(rc.x, rc.y+1, rc.z);";break;case 2:f="outputCoords = ivec3(rc.x, rc.y, rc.z+1);";break;case 3:f="outputCoords = ivec3(rc.x, rc.y+1, rc.z+1);";break;default:throw new Error}s+=`
  ...
  `,name:e,type:0}}var At,Ip,vs,Is,_s,Ss,Os,As,Ps,Es,Ds,Ls,$s,ks,Bs=x(()=>{"use strict";U();Xt();X();R();At=(i,e,o,t=e[0].type,r)=>{let n=i.session.pack?2:0;return{name:o.name,inputNames:["A","B"],inputTypes:[n,n],cacheHint:r,get:()=>Ip(i,e,o,t)}},Ip=(i,e,o,t=e[0].type)=>{let r=i.session.pack?2:0,n=!A.areEqual(e[0].dims,e[1].dims),s=e[0].dims,a=i.session.pack;if(n){let f=dt.calcShape(e[0].dims,e[1].dims,!1);if(!f)throw new Error("Can't perform binary op on the given tensors");s=f;let c=s.length,d=e[0].dims.length!==0?e[0].dims.length:1,m=e[1].dims.length!==0?e[1].dims.length:1,y=e[0].dims.length!==0?"bcastIndices_A(indices, aindices);":"aindices[0] = 0;",g=e[1].dims.length!==0?"bcastIndices_B(indices, bindices);":"bindices[0] = 0;",T=D(i.session.backend.glContext.version),_=a?`
    ...
    `;return{name:o.name,inputNames:["A","B"],inputTypes:[r,r],output:{dims:e[0].dims,type:t,textureType:r},shaderSource:l,hasMain:!0}},vs=(i,e)=>[i.run(At(i,e,fp()),e)],Is=(i,e)=>[i.run(At(i,e,yp(),"bool"),e)],_s=(i,e)=>[i.run(At(i,e,cp()),e)],Ss=(i,e)=>[i.run(At(i,e,hp(),"bool"),e)],Os=(i,e)=>[i.run(At(i,e,mp(),"bool"),e)],As=(i,e)=>[i.run(At(i,e,bp(),"bool"),e)],Ps=(i,e)=>[i.run(At(i,e,pp()),e)],Es=(i,e)=>[i.run(At(i,e,gp(),"bool"),e)],Ds=(i,e)=>[i.run(At(i,e,Tp()),e)],Ls=(i,e)=>[i.run(At(i,e,wp()),e)],$s=(i,e)=>[i.run(At(i,e,dp()),e)],ks=(i,e)=>[i.run(At(i,e,xp(),"bool"),e)]});var Fs,Ns,Sp,Cs=x(()=>{"use strict";U();Fs=(i,e,o)=>(Sp(e),[i.cast(e[0],o)]),Ns=i=>ut.tensorDataTypeFromProto(i.attributes.getInt("to")),Sp=i=>{if(!i||i.length!==1)throw new Error("Cast requires 1 input.");if(i[0].type==="string")throw new Error("Invalid input type.")}});var Op,Ap,Rs,Wr,Gs=x(()=>{"use strict";X();R();Vt();ge();Op=(i,e)=>({name:"Concat (packed)",inputNames:Array.from({length:i},(o,t)=>`X${t}`),inputTypes:Array(i).fill(2),cacheHint:e}),Ap=(i,e,o,t)=>{let r=o[0].dims.slice();if(t>=r.length||t<-1*r.length)throw new Error("axis specified for concat doesn't match input dimensionality");t<0&&(t=r.length+t);let n=r.slice(0);for(let B=1;B<o.length;B++){let Q=o[B].dims.slice();for(let pt=0;pt<r.length;pt++)if(pt===t)n[t]+=Q[pt];else if(r[pt]!==Q[pt])throw new Error("non concat dimensions must match")}let s=n.length,a=Fe("coords",s),u=ht(s),l=Ut(),f=o.map(B=>B.dims),c=Rt(s),d=new Array(f.length-1);d[0]=f[0][t];for(let B=1;B<d.length;B++)d[B]=d[B-1]+f[B][t];let m=c[t],y=c.slice(-2),g=c.join(),T=`if (${m} < ${d[0]}) {
        return getChannel(
            getX0(${g}), vec2(${y.join()}));
...
`)},Us=i=>F({axis:i.attributes.getInt("axis")}),Bp=i=>{if(!i||i.length<1)throw new Error("too few inputs");let e=i[0].type,o=i[0].dims.length;if(e==="string")throw new Error("string tensor is not supported yet");for(let t of i){if(t.type!==e)throw new Error("input tensors should be one type");if(t.dims.length!==o)throw new Error("input tensors should have the same shape")}}});function Fp(){return Pt("abs")}function Np(){return Pt("acos")}function Cp(){return Pt("asin")}function Rp(){return Pt("atan")}function Gp(){return Pt("ceil")}function Mp(){return Pt("cos")}function Vp(i){let e="elu";return{body:`
  ...
  `,name:e,type:0}}function Up(){return Pt("exp")}function zp(){return Pt("floor")}function ho(i,e){let o="clip";return{body:`
  ...
  `,name:e,type:0}}function qp(){return Pt("log")}function jp(){let i="neg";return{body:`
  float ${i}_(float a) {
    return -a;
  }
  vec4 ${i}_(vec4 v) {
  ...
  `,name:i,type:0}}function Kp(){return Pt("sin")}function mo(){let i="relu";return{body:`
  float ${i}_(float a) {
    return max( a, 0.0 );
  }
  vec4 ${i}_(vec4 v) {
  ...
  `,name:i,type:0}}function Jp(){return Pt("sqrt")}function Zp(){return Pt("tan")}function Yp(){let i="tanh";return{body:`
  float ${i}_(float a) {
    a = clamp(a, -10., 10.);
    a = exp(2.*a);
    return (a - 1.) / (a + 1.);
...
`)}),f=`${c}
 ${f}`,f=f.replace("return",`${a} = `);let d=`
      ...
      `;i=i.replace(o[0],d)}}return i=i.replace(df,""),i}var df,Uh,mf=x(()=>{"use strict";df=/@inline[\s\n\r]+(\w+)[\s\n\r]+([0-9a-zA-Z_]+)\s*\(([^)]*)\)\s*{(([^}]|[\n\r])*)}/gm,Uh="(\\w+)?\\s+([_0-9a-zA-Z]+)\\s+=\\s+__FUNC__\\((.*)\\)\\s*;"});function Re(i,e){let o=[],t=[],r=e!=null&&Array.isArray(e)&&e.length===0,n=e==null||r?null:zh(e,i).sort(),s=0;for(let a=0;a<i.length;++a){if(n!=null){if(n[s]===a&&i[a]!==1)throw new Error(`Can't squeeze axis ${a} since its dim '${i[a]}' is not 1`);(n[s]==null||n[s]>a)&&i[a]===1&&(o.push(i[a]),t.push(a)),n[s]<=a&&s++}i[a]!==1&&(o.push(i[a]),t.push(a))}return{newShape:o,keptDims:t}}function zh(i,e){let o=e.length;return i=i==null?e.map((t,r)=>r):[].concat(i),$e(i.every(t=>t>=-o&&t<o),()=>`All values in axis param must be in range [-${o}, ${o}) but got axis ${i}`),$e(i.every(Wh),()=>`All values in axis param must be integers but got axis ${i}`),i.map(t=>t<0?o+t:t)}function Wh(i){return i%1===0}function Hh(i){if(i.length===0)return 1;let e=i[0];for(let o=1;o<i.length;o++)e*=i[o];return e}function bf(i){let e=Math.ceil(Math.sqrt(i));return[e,Math.ceil(i/e)]}var Yr,Co=x(()=>{"use strict";vt();U();Yr=class{constructor(e){this.maxTextureSize=e}computeTextureWH(e,o){let t=this.computeTexture(e,o);return o&&o.isPacked&&(t[0]/=2,t[1]/=2),o&&o.reverseWH?[t[1],t[0]]:t}computeTexture(e,o){let t=o&&o.isPacked;if(e.length===0)return t?[2,2]:[1,1];let r=this.maxTextureSize;if(o&&o.breakAxis!==void 0){let a=o.breakAxis>=e.length?1:e.slice(o.breakAxis).reduce((l,f)=>l*f),u=o.breakAxis<=0?1:e.slice(0,o.breakAxis).reduce((l,f)=>l*f);if(a>r||u>r)z.verbose("TextureLayout",`Given width/height preferences were unattainable: shape:${e}, breakAxis:${o.breakAxis}`);else return[a,u]}let n=e.slice(0);t&&(r=r*2,n=n.map((a,u)=>u>=n.length-2?n[u]%2===0?n[u]:n[u]+1:n[u]),n.length===1&&(n=[2,n[0]])),n.length!==2&&(n=Re(n).newShape);let s=Hh(n);return n.length<=1&&s<=r?[1,s]:n.length===2&&n[0]<=r&&n[1]<=r?n:n.length===3&&n[0]*n[1]<=r&&n[2]<=r?[n[0]*n[1],n[2]]:n.length===3&&n[0]<=r&&n[1]*n[2]<=r?[n[0],n[1]*n[2]]:n.length===4&&n[0]*n[1]*n[2]<=r&&n[3]<=r?[n[0]*n[1]*n[2],n[3]]:n.length===4&&n[0]<=r&&n[1]*n[2]*n[3]<=r?[n[0],n[1]*n[2]*n[3]]:t?bf(s/4).map(a=>a*2):bf(s)}}});var Qr,yf=x(()=>{"use strict";U();Xt();X();Co();Vt();Qr=class extends Ot{constructor(o){super(o)}getFunctions(){return{...this.offsetToCoords(),...this.coordsToOffset(),...this.toVec(),...this.valueFrom(),...this.getCommonUtilFuncs(),...this.getInputsSamplingSnippets(),...this.getOutputSamplingSnippet()}}getCustomTypes(){return{}}offsetToCoords(){let o="offsetToCoords";return{offsetToCoords:new O(`
    ...
    `),t="packedUVfrom1D",o[t]=new O(`
      ...
      `),t="sampleTexture";let r=D(this.context.glContext.version);return o[t]=new O(`
        ...
        }`),o}getInputsSamplingSnippets(){let o={},t=this.context.outputTextureLayout;return this.context.programInfo.inputNames.forEach((r,n)=>{let s=this.context.inputTextureLayouts[n],a=Rr(r);s.isPacked?o[a]=this.getPackedSamplerFromInput(a,r,s):o[a]=this.getUnpackedSamplerFromInput(a,r,s);let u=ns(r);s.unpackedShape.length<=t.unpackedShape.length&&(s.isPacked?o[u]=this.getPackedSamplerAtOutputCoords(u,s,t,r):o[u]=this.getUnpackedSamplerAtOutputCoords(u,s,t,r))}),o}getPackedSamplerAtOutputCoords(o,t,r,n){let s=t.unpackedShape,a=r.unpackedShape,l=Rr(n),f=s.length,c=a.length,d=dt.getBroadcastDims(s,a),m=ht(c),y=c-f,g,T=Rt();f===0?g="":c<2&&d.length>=1?g="coords = 0;":g=d.map(Gt=>`coords.${T[Gt+y]} = 0;`).join(`
`);let _="";c<2&&f>0?_="coords":_=s.map((Gt,mt)=>`coords.${T[mt+y]}`).join(", ");let w="return outputValue;",L=A.size(s)===1,Q=A.size(a)===1;if(f===1&&!L&&!Q)w=`
        return vec4(outputValue.xy, outputValue.xy);
      `;else if(L&&!Q)c===1?w=`
          return vec4(outputValue.x, outputValue.x, 0., 0.);
        `:w=`
          return vec4(outputValue.x);
        `;else if(d.length){let Gt=f-2,mt=f-1;d.indexOf(Gt)>-1&&d.indexOf(mt)>-1?w="return vec4(outputValue.x);":d.indexOf(Gt)>-1?w="return vec4(outputValue.x, outputValue.y, outputValue.x, outputValue.y);":d.indexOf(mt)>-1&&(w="return vec4(outputValue.xx, outputValue.zz);")}let pt=`
    ...
    `;return new O(Ht,["coordinates.getOutputCoords"])}getUnpackedSamplerAtOutputCoords(o,t,r,n){let s=[r.width,r.height],a=[t.width,t.height],u=t.unpackedShape.length,l=r.unpackedShape.length,f=t.unpackedShape,c=r.unpackedShape,d=Rr(n);if(u===l&&de.arraysEqual(a,s)){let L=`
        ...
        `;return new O(L,["coordinates.sampleTexture"])}let m=ht(l),y=dt.getBroadcastDims(f,c),g=l-u,T,_=Rt();u===0?T="":l<2&&y.length>=1?T="coords = 0;":T=y.map(L=>`coords.${_[L+g]} = 0;`).join(`
`);let w="";l<2&&u>0?w="coords":w=t.unpackedShape.map((L,B)=>`coords.${_[B+g]}`).join(", ");let v=`
    ...
    `;return{toVec:new O(u,["coordinates.coordsToOffset"])}}valueFrom(){let o={};return this.context.programInfo.inputNames.forEach((t,r)=>{let n=this.context.inputTextureLayouts[r],a=(n.unpackedShape.length>0?n.unpackedShape:n.shape).length,u=`_${t}`;o[u]=new O(this.getValueFromSingle(t,a,n.width,n.height,!1),[`shapeUtils.indicesToOffset${u}`,"coordinates.offsetToCoords","fragcolor.getColorAsFloat"]),u=u+"_T",o[u]=new O(this.getValueFromSingle(t,a,n.width,n.height,!0),[`shapeUtils.indicesToOffset${u}`,"coordinates.offsetToCoords","fragcolor.getColorAsFloat"])}),o}getValueFromSingle(o,t,r,n,s){let a=`_${o}`;s&&(a=a+"_T");let u=D(this.context.glContext.version);return`
        ...
        `}}});var tn,gf=x(()=>{"use strict";Xt();tn=class i extends Ot{constructor(e){super(e)}getFunctions(){return{...this.encodeFloat32(),...this.decodeFloat32()}}getCustomTypes(){return{}}encodeFloat32(){return{encode:new O(`highp vec4 encode(highp float f) {
      ...
      `}incrementIndices(){let e={};return this.context.programInfo.inputNames.forEach((o,t)=>{let r=this.context.inputTextureLayouts[t].shape,n=r.length,s=`incrementIndices_${o}`,a="";for(let l=0;l<n;++l)a+=`
        ...
        `;e[s]=new O(u)}),e}}});var nn,wf=x(()=>{"use strict";Xt();nn=class extends Ot{constructor(e){super(e)}getCustomTypes(){return{}}getFunctions(){return{...this.binaryVecFunctions(),...this.copyVec(),...this.setVecItem(),...this.getVecItem()}}binaryVecFunctions(){let o=this.context.outputTextureLayout.shape.length,t={add:"+=",sub:"-=",mul:"*=",div:"/="},r={};for(let n in t){let s=`${n}Vec`,a="";for(let l=0;l<o;++l)a+=`
          dest[${l}] ${t[n]} src[${l}];
          `;let u=`
